...
export const chessRecords = pgTable('chess_records', {
  ...
  skillsUsed: json('skills_used')
    .$type<Array<{ skill: string; step: number }>>()
    .default([])
    .notNull(),
...
export const playerStats = pgTable('player_stats', {
  ...
  // 围棋水平评分（自适应难度系统）
  // 0-100，0=完全新手，100=顶尖高手
  // 新玩家默认25，赢了涨、输了降，用于动态调整AI难度
  goSkillRating: integer('go_skill_rating').notNull().default(25),
