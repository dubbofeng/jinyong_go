...
console.log(`测试 ${samples} 个样本 (scale=${scale}, octaves=${octaves}, persistence=${persistence})...\n`);
...
console.log('\n地形分布 (hall主题):');
console.log(`  wood: ${distribution.wood} (${(distribution.wood / samples * 100).toFixed(1)}%) - 期望 70%`);
console.log(`  gold: ${distribution.gold} (${(distribution.gold / samples * 100).toFixed(1)}%) - 期望 15%`);
console.log(`  dirt: ${distribution.dirt} (${(distribution.dirt / samples * 100).toFixed(1)}%) - 期望 10%`);
console.log(`  fire: ${distribution.fire} (${(distribution.fire / samples * 100).toFixed(1)}%) - 期望 5%`);
