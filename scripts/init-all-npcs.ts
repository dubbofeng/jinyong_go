...
const npcData = [
  ...
  // ===== 第一章：中原风云（1-15级）=====
  {
    ...
    name: '洪七公',
    nameEn: 'Hong Qigong',
    description: '丐帮帮主，武林泰斗。性格豪爽，武功高强，尤其擅长降龙十八掌和打狗棒法。',
  ...
  // ===== 第二章：大理佛缘（16-25级）=====
  {
    ...
    name: '段誉',
    nameEn: 'Duan Yu',
    description: '大理国世子，儒雅温和，精通围棋。曾在万劫谷中学会六脉神剑。',
    descriptionEn: 'Prince of Dali Kingdom, refined and gentle, expert in Go. Learned Six Meridians Divine Sword.',
    mapId: 'tianlong_scene',
    positionX: 16,
    positionY: 16,
    npcType: 'teacher',
    difficulty: 5,
    teachableSkills: ['liumai_shenjian'],
    chapter: 2,
  ...
  },
  {
    ...
    name: '杨过',
    nameEn: 'Yang Guo',
    description: '神雕侠，小龙女的挚爱。黯然销魂掌的创始人，棋艺亦高超。',
    descriptionEn: 'Divine Eagle Hero, deeply in love with Xiaolongnv. Creator of Palms of Ecstasy.',
    mapId: 'huashan_scene',
    positionX: 20,
    positionY: 20,
    npcType: 'teacher',
    difficulty: 9,
    teachableSkills: ['anran_xiaohun'],
    chapter: 5,
  ...
  },
  {
    ...
    name: '乔峰',
    nameEn: 'Qiao Feng',
    description: '丐帮前帮主，英雄盖世。降龙十八掌威震武林，棋艺与武学相通。',
    descriptionEn: 'Former leader of Beggar Sect, greatest hero. Master of Eighteen Dragon-Subduing Palms.',
    mapId: 'leigu_scene',
    positionX: 16,
    positionY: 16,
    npcType: 'teacher',
